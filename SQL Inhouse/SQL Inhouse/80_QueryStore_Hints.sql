...
/*
     ...
     used to filter AgentId. 
	 Looking at the statistics for AgentId,
     you will see that there is a big skew for AgentId 101. --->100000
*/
...
*/
EXEC sp_query_store_set_hints @query_id=31, 
...
*/
EXEC sp_query_store_clear_hints @query_id = 31;
GO
